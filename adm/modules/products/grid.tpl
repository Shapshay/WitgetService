...
jQuery("#toolbar").jqGrid({
	url:'modules/products/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Дата создания','Название','Цена','В наличии'],
   	colModel:[
		...
		{name:'cost',index:'cost', width:120, align:'center', sorttype:"text"},
		{name:'status',index:'status', width:60, align:'center', editable:true, edittype:"checkbox", formatter:'checkbox',formatoptions:{disabled: true}}
   	],
   	rowNum:25,
	rowTotal: 2000,
	rowList : [25,50,100],
	...
	editurl: 'modules/products/del.php'	
});
