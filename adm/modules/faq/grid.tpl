...
jQuery("#toolbar").jqGrid({
	url:'modules/faq/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Дата','Имя','Вопрос', 'Отображать'],
   	colModel:[
		...
		{name:'date',index:'date', width:80, align:'center', editable:true, edittype:"text", sorttype:"text"},
   		...
   		{name:'question',index:'question', sorttype:"text"},
	...
	gridComplete: function(){
		...
		for(var i=0;i < ids.length;i++){
			...
			be = "<a href=\"{FAQ_EDIT_URL}"+cl+"\" title=\"{STR_EDIT}\"><img src=\"images/edit_view.png\" border=\"0\"></a>";
