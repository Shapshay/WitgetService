...
jQuery("#toolbar").jqGrid({
	url:'modules/post_stat/grid.php',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['ID','Название рассылки', 'Дата', 'Отправлено', 'Открыто'],
   	colModel:[
		{name:'id',index:'id', width:25, sorttype:"int"},
   		{name:'theme',index:'email', align:'center', sorttype:"text"},
		{name:'date',index:'date', width:80, align:'center', editable:true, edittype:"text", sorttype:"text"},
		{name:'otpr',index:'otpr', width:80, sorttype:"int"},
		{name:'otkr',index:'otkr', width:80, sorttype:"int"}
   	],
   	rowNum:100,
	rowTotal: 20000000,
	rowList : [100,250,500],
