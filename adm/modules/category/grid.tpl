...
jQuery("#toolbar").jqGrid({
	url:'modules/category/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Категории продукции'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
		{name:'title',index:'title', width:750, align:'center', sorttype:"text"}
   	],
   	rowNum:25,
	rowTotal: 2000,
	rowList : [25,50,100],
	...
	editurl: 'modules/category/del.php'	
});
