...
$result = mysql_query("SELECT COUNT(*) AS count FROM variables");
...
$SQL = "SELECT id, name, val FROM variables WHERE page_id = ".$_GET['ch']." LIMIT $start , $limit";
//echo $SQL;
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array("",$row['id'],$row['name'],$row['val']);
	$i++;
} 
