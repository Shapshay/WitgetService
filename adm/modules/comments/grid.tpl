...
jQuery("#toolbar").jqGrid({
	url:'modules/comments/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Дата комментария','Название','Имя','Комментарий','Показывать'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
		{name:'date',index:'date', width:80, align:'center', sorttype:"text"},
		{name:'art_id',index:'art_id', width:120, align:'center', sorttype:"text"},
		{name:'name',index:'name', width:80, align:'center', sorttype:"text"},
		{name:'comment',index:'comment', width:120, align:'center', sorttype:"text"},
		{name:'view',index:'view', width:60, align:'center', editable:true, edittype:"checkbox", formatter:'checkbox',formatoptions:{disabled: true}}
   	],
   	rowNum:25,
	rowTotal: 2000,
	rowList : [25,50,100],
	...
	editurl: 'modules/comments/del.php'	
});
