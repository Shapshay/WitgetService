...
jQuery("#toolbar").jqGrid({
	url:'modules/guestbook/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Дата','Имя','Отзыв', 'Отображать'],
   	colModel:[
		...
		{name:'date',index:'date', width:80, align:'center', editable:true, edittype:"text", sorttype:"text"},
   		{name:'name',index:'name', width:120, align:'center', sorttype:"text"},
   		{name:'text',index:'text', sorttype:"text"},
		{name:'view',index:'view', width:82, align:'center', editable:true, edittype:"checkbox", formatter:'checkbox',formatoptions:{disabled: true}}
   	],
   	rowNum:25,
	rowTotal: 2000,
	rowList : [25,50,100],
	...
	gridComplete: function(){
		...
		for(var i=0;i < ids.length;i++){
			...
			be = "<a href=\"{OTZ_EDIT_URL}"+cl+"\" title=\"{STR_EDIT}\"><img src=\"images/edit_view.png\" border=\"0\"></a>";
	...
	editurl: 'modules/guestbook/del.php'	
});
