...
$SQL = "SELECT id, name, date, text, view FROM guestbook WHERE page_id = ".$_GET['ch']." ORDER BY date DESC LIMIT $start , $limit";
//echo $SQL;
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array("",$row['id'],$row['date'],$row['name'],$row['text'],$row['view']);
	$i++;
} 
