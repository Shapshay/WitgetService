...
jQuery("#toolbar").jqGrid({
	url:'modules/widgets/grid.php',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Название виджета','Папка','Показывать'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
		{name:'title',index:'title', width:400, align:'center', sorttype:"text"},
		{name:'folder',index:'folder', width:350, align:'center', sorttype:"text"},
	...
	editurl: 'modules/widgets/del.php'	
});
