...
$result = mysql_query("SELECT COUNT(*) AS count FROM widgets");
...
$SQL = "SELECT id, title,folder,view FROM widgets LIMIT $start , $limit";
//echo $SQL;
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array("",$row['id'],$row['title'],$row['folder'],$row['view']);
	$i++;
} 
