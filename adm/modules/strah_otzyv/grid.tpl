...
jQuery("#toolbar").jqGrid({
	url:'modules/strah_otzyv/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Дата','Возраст','Имя'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
		{name:'date',index:'date', width:120, align:'center', sorttype:"text"},
		{name:'year',index:'year', width:120, align:'center', sorttype:"text"},
	...
	editurl: 'modules/strah_otzyv/del.php'	
});
