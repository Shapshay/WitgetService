...
$result = mysql_query("SELECT COUNT(*) AS count FROM strah_otzyv");
...
$SQL = "SELECT id, date,year,name FROM strah_otzyv LIMIT $start , $limit";
//echo $SQL;
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array("",$row['id'],$row['date'],$row['year'],$row['name']);
	$i++;
} 
