...
$result = mysql_query("SELECT COUNT(*) AS count FROM tarifs");
...
$SQL = "SELECT id, title,s_count,w_count,tech,copyright FROM tarifs LIMIT $start , $limit";
//echo $SQL;
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
	...
	$responce->rows[$i]['cell']=array("",$row['id'],$row['title'],$row['s_count'],$row['w_count'],$row['tech'],$row['copyright']);
	$i++;
} 
