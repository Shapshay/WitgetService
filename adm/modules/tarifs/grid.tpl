...
jQuery("#toolbar").jqGrid({
	url:'modules/tarifs/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Название тарифа','Количество сайтов','Количество виджетов','Техподдержка','Копирайт'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
		{name:'title',index:'title', width:120, align:'center', sorttype:"text"},
		{name:'s_count',index:'s_count', width:120, align:'center', sorttype:"text"},
		{name:'w_count',index:'w_count', width:120, align:'center', sorttype:"text"},
		{name:'tech',index:'tech',  width:60, align:'center', editable:true, edittype:"checkbox", formatter:'checkbox',formatoptions:{disabled: true}},
		{name:'copyright',index:'copyright',  width:60, align:'center', editable:true, edittype:"checkbox", formatter:'checkbox',formatoptions:{disabled: true}}
   	],
   	rowNum:25,
	rowTotal: 2000,
	rowList : [25,50,100],
	...
	gridComplete: function(){
		...
		for(var i=0;i < ids.length;i++){
			...
			be = "<a href=\"{ITEM_EDIT_URL}"+cl+"\" title=\"{STR_EDIT}\"><img src=\"images/edit_view.png\" border=\"0\"></a>";
	...
	editurl: 'modules/tarifs/del.php'	
});
