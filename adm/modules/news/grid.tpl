...
jQuery("#toolbar").jqGrid({
	url:'modules/articles/grid.php?ch={PAGE_ID}',
	datatype: "json",
	height: 300,
	width: 800,
   	colNames:['Ред.','ID','Название','Дата'],
   	colModel:[
		{name:'act',index:'act', width:25,sortable:false, align:'center'},
		{name:'id',index:'id', width:25, sorttype:"int"},
   		{name:'title',index:'title', align:'center', sorttype:"text"},
	...
	gridComplete: function(){
		...
		for(var i=0;i < ids.length;i++){
			...
			be = "<a href=\"{ARTS_EDIT_URL}"+cl+"\" title=\"{STR_EDIT}\"><img src=\"images/edit_view.png\" border=\"0\"></a>";
	...
	editurl: 'modules/articles/del.php'	
});
