var strVar="";
strVar += "<script src=\"http:\/\/witgetservice.com\/wdt\/js\/ulp-jsonp12.js\"><\/script>";
strVar += "<style>";
strVar += ".ulp-overlay {";
