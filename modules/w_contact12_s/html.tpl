...
function update21(picker) {
    document.getElementById('rgb-str21').value = picker.toHEXString().replace('#', '');
    //document.getElementById('rgb-str2').value = picker.toRGBString().replace('rgb(', '').replace(')', '');
}
...
function update54(picker) {
    //document.getElementById('hex-str').value = picker.toHEXString();
    document.getElementById('rgb-str54').value = picker.toHEXString().replace('#', '');
}
function update55(picker) {
    //document.getElementById('hex-str').value = picker.toHEXString();
    document.getElementById('rgb-str55').value = picker.toHEXString().replace('#', '');
}
</script>
<script>
$(function(){
