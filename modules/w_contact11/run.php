<?php
	# SETTINGS #############################################################################
	$moduleName = "w_contact11";
	$prefix = "./modules/".$moduleName."/";
	$tpl->define(array(
			$moduleName => $prefix . $moduleName.".tpl",
			$moduleName . "main" => $prefix . "main.tpl",
			$moduleName . "html" => $prefix . "html.tpl",
			$moduleName . "script" => $prefix . "w_contact11.js",
	));
	# MAIN #################################################################################
	//echo "Y";
	if(!isset($_GET['u'])){
	...
	if(db_num_rows($result) > 0){
		...
		$tpl->assign("WDT_EDT_W_TITLE1", $options->w_title1);
		$tpl->assign("WDT_EDT_W_TEXT1", $options->w_text1);
		$tpl->assign("WDT_EDT_TEXT_COLOR1", $options->text_color1);
		$tpl->assign("WDT_EDT_W_TITLE2", $options->w_title2);
		$tpl->assign("WDT_EDT_W_TEXT2", $options->w_text2);
		$tpl->assign("WDT_EDT_TEXT_COLOR2", $options->text_color2);
		$tpl->assign("WDT_EDT_W_TITLE3", $options->w_title3);
		$tpl->assign("WDT_EDT_W_TEXT3", $options->w_text3);
		$tpl->assign("WDT_EDT_TEXT_COLOR3", $options->text_color3);
		$tpl->assign("WDT_EDT_W_TITLE4", $options->w_title4);
		$tpl->assign("WDT_EDT_W_TEXT4", $options->w_text4);
		$tpl->assign("WDT_EDT_TEXT_COLOR4", $options->text_color4);
