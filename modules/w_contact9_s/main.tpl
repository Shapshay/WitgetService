...
<div><strong>Название компании</strong><br>
<input type="text" name="w_company" value="{WDT_EDT_COMPANY}" class="settings_inp"></div>
<div><strong>Заголовок окна</strong><br>
<input type="text" name="w_title" value="{WDT_EDT_TITLE}" class="settings_inp"></div>
