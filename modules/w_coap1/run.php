<?php
	...
	$tpl->define(array(
			...
			$moduleName . "script" => $prefix . "w_coap1.js",
	));
	# MAIN #################################################################################
	//echo "Y";
	if(!isset($_GET['u'])){
	...
	if(db_num_rows($result) > 0){
		...
		$tpl->assign("WDT_EDT_INP_PLACE4", $options->inp_place4);
		$tpl->assign("WDT_EDT_INP_PLACE5", $options->inp_place5);
		$tpl->assign("WDT_EDT_SUCCESS", $options->coap_success);
