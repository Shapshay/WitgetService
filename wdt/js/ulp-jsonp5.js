...
function ulp_subscribe(object) {
	...
	//else phone = '';
	gn = jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-gn"]').val();
	pn = jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-pn"]').val();
		...
		success: function(data) {
			...
			try {
				...
				if (status == "OK") {
					...
					if (data.phone == 'ERROR') {
						jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-phone"]').addClass("ulp-input-error");
						//alert(data.phone_str);
					}
					if (data.gn == 'ERROR') jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-gn"]').addClass("ulp-input-error");
					if (data.pn == 'ERROR') jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-pn"]').addClass("ulp-input-error");
